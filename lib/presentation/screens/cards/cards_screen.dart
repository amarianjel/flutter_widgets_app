...
class _CardsView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(  //README: Sirve para cuando escapa a la vista
      child: Column(
        children: [
          ...
          const SizedBox(height: 50 ),  //+ Para que se vea mejor el scroll
        ],
      ),
    );
  }
          ...
          Align(
            ...
            child: Container(
              decoration: const BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.only( bottomLeft: Radius.circular(20) )  //+ Para los puntos
              ),
              child: IconButton(
                icon: const Icon( Icons.more_vert_outlined),
                onPressed: () {},
